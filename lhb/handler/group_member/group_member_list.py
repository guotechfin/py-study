...
class GroupMemberList(web_handler.WebHandler):
    def prepare(self):
        self.resp_json = ""
        self.ret, self.msg = error_msg.SUCCESS
        self.group_member_list = list()
        self.total = 0
    ...
    def response(self):
        ...
        resp_dict['group_member_list'] = utility.to_obj(self.group_member_list)
    ...
    def get(self):
        self.group_member_list, self.total = (
                group_member_obj.search_group_member_list(
               self._db_session,
